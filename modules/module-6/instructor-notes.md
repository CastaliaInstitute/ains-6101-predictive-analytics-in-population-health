...
Students should use **intervention targeting and evaluation** to make a defensible technical or managerial decision in this setting: a population health team prioritizing outreach for patients with elevated near-term risk.

## Before Class

- Review the lab output and identify one result that can be challenged.
- Prepare one domain-specific failure case related to Predictive Analytics in Population Health.
