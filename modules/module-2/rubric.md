...
risk stratification brief with equity checks, intervention criteria, and monitoring plan focused on risk stratification and prediction: Build or specify a risk stratification model.
...
| Domain reasoning | Connects results to Predictive Analytics in Population Health with accurate terminology and realistic operational implications. | Uses relevant terminology but misses some operational implications. | Reasoning is generic and could apply to almost any AI course. |
...
| Communication | Recommendation is concise, defensible, and understandable to population health director, care manager, privacy officer, and community advisory representative. | Recommendation is understandable but not fully defended. | Recommendation is unclear, unsupported, or overclaims what the evidence proves. |
